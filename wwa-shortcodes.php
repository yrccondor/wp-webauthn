...
function wwa_localize_frontend(){
    ...
    wp_localize_script('wwa_frontend_js', 'wwa_php_vars', array(
        ...
        'i18n_6' => '<span class="wwa-success">'.__('Authenticated', 'wwa'),
        'i18n_7' => '<span class="wwa-failed">'.__('Auth failed', 'wwa').'</span>',
        'i18n_8' => __('No', 'wwa'),
        'i18n_9' => __(' (Unavailable)', 'wwa'),
        'i18n_10' => __('The site administrator has disabled usernameless login feature.', 'wwa'),
        'i18n_11' => __('Error: The username field is empty.', 'wwa'),
        'i18n_12' => __('Please enter the authenticator identifier', 'wwa'),
        ...
        'i18n_17' => __('Loading failed, maybe try refreshing?', 'wwa'),
        ...
        'i18n_23' => __('No registered authenticators', 'wwa'),
        'i18n_24' => __('Any', 'wwa'),
        'i18n_25' => __('Platform authenticator', 'wwa'),
        'i18n_26' => __('Roaming authenticator', 'wwa'),
        'i18n_27' => __('Remove', 'wwa'),
        'i18n_28' => __('Please follow instructions to finish registration...', 'wwa'),
        'i18n_29' => '<span class="success">'._x('Registered', 'action', 'wwa').'</span>',
        'i18n_30' => '<span class="failed">'.__('Registration failed', 'wwa').'</span>',
        'i18n_31' => __('Your browser does not support WebAuthn', 'wwa'),
        'i18n_32' => __('Registrating...', 'wwa'),
        'i18n_33' => '<br><span class="wwa-try-username">'.__('Try to enter the username', 'wwa').'</span>',
        'i18n_34' => __('After removing this authenticator, you will not be able to login with WebAuthn', 'wwa'),
        'i18n_35' => __(' (Disabled)', 'wwa'),
        'i18n_36' => __('The site administrator only allow platform authenticators currently.', 'wwa'),
        'i18n_37' => __('The site administrator only allow roaming authenticators currently.', 'wwa')
    ));
}
...
function wwa_list_shortcode($vals){
    ...
    $tfoot = '</tbody><tfoot><tr><th>'.__('Identifier', 'wwa').'</th><th>'.__('Type', 'wwa').'</th><th>'._x('Registered', 'time', 'wwa').'</th><th>'.__('Last used', 'time', 'wwa').'</th><th class="wwa-usernameless-th">'.__('Usernameless', 'wwa').'</th><th>'.__('Action', 'wwa').'</th></tr></tfoot></table></div><p class="wwa-authenticator-list-usernameless-tip"></p><p class="wwa-authenticator-list-type-tip"></p>';
