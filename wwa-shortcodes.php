...
function wwa_list_shortcode($vals){
    ...
    $thead = '<div class="wwa-table-container"><table class="wwa-list-table"><thead><tr><th>'.__('Identifier', 'wwa').'</th><th>'.__('Type', 'wwa').'</th><th>'._x('Registered', 'time', 'wwa').'</th><th>'.__('Last used', 'time', 'wwa').'</th><th>'.__('Usernameless', 'wwa').'</th><th>'.__('Action', 'wwa').'</th></tr></thead><tbody class="wwa-authenticator-list">';
    $tfoot = '</tbody><tfoot><tr><th>'.__('Identifier', 'wwa').'</th><th>'.__('Type', 'wwa').'</th><th>'._x('Registered', 'time', 'wwa').'</th><th>'.__('Last used', 'time', 'wwa').'</th><th>'.__('Usernameless', 'wwa').'</th><th>'.__('Action', 'wwa').'</th></tr></tfoot></table></div>';
