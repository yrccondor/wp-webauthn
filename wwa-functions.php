...
// Destroy all sessions when user state changed
...
function wwa_login_js() {
    wp_enqueue_script('wwa_jquery', plugins_url('js/jquery.min.js',__FILE__));
    wp_enqueue_script('wwa_login', plugins_url('js/login.js',__FILE__));
    ...
    if(wwa_get_option('first_choice') === 'true'){
        wp_enqueue_script('wwa_default', plugins_url('js/default_wa.js',__FILE__));
    }
